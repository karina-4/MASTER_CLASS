...
#SBATCH --mail-user=kali4487@colorado.edu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=6gb
...
--outdir /scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/04_RNAseq_Dox/01_Mouse_dox_wt/dox_long/dox_long_output \
