...
#good practice!! a good thing to check while coding
...
save(res_df, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/06_Differential_expression_analyses/results/time_point_res_df.RData")
# let's also save our DDS
save(dds_time_point, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/06_Differential_expression_analyses/results/dds_time_point_mouse_long.RData")
```
