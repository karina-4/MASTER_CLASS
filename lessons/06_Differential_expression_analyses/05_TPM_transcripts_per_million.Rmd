...
TPM <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/Data/salmon.merged.gene_tpm.tsv", header=TRUE, row.names=1)
...
hist(TPM_not_zero$WT_0_1, xlim = c(0,300), breaks = 100)
...
counts_matrix <- counts_matrix %>%
  select(-gene_name) # average gene .b
...
# Convert the list to a data frame - in a simple way!! (maybe not the best because have to manually name things now)
