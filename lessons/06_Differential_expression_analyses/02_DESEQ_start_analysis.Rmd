...
```{r loading data}
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/05_RNAseq_in_R_studio/results/count_files.RData", verbose = T)
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/05_RNAseq_in_R_studio/results/deseq_samples.RData", verbose = T)
```
...
# The order you choose to merge matters!
...
view(res_0_df)
# rows are same, then paste the columns in the order or column 1, 9, then 2 - 8
...
# project: make plots of different p values
...
# project: make plots of how it will change from 2 fold to 1.5 fold to 0.5 fold etc. 
