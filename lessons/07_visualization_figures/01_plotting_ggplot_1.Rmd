...
# load TPM RESULTS: 
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/06_Differential_expression_analyses/results/results06/TPM_results.Rdata")

# laod DESEQ2 results
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kali4487/MASTER_CLASS/lessons/06_Differential_expression_analyses/results/results06/DESEQ_results.rdata")
...
```
# RESULT: interesting we see that the latest time points have the largest fold change
