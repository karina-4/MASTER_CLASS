...
#If you got an error for the union command, it is because there are a lot of functions called union, you can do IRanges::union to specify which package to pull from
...
# NOTE: the order of (p1,p2) vs. (p2,p1) matters!! There is a difference in output 
