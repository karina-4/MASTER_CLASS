...
table(gencode_gr@elementMetadata$gene_name) %>% 
  head(100)
# NOTE:: need to think about what these values are and how to compare then to different formats of the same information...
...
# NOTE: probably one of the first steps you want to do on choose your own adventure

table(gencode_gr_length$gene_type)
# tells how many protein coding genes, how many pseudogenes, how many scRNA, how many snowRNAs, lincRNA, etc 
